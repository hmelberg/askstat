---
id: ipums
navn: IPUMS (NHIS/MEPS/International)
utgiver: IPUMS / University of Minnesota
tillit: etablert
tilgang: rest
...
auth:
  type: api_key
  user: true
  plassering: header:Authorization
nokkel_hint: gratis konto på ipums.org → API key
tags: [mikro]
order: 20
---

# IPUMS (NHIS/MEPS/International)
...
IPUMS (NHIS/MEPS/International) — harmonized health and social survey microdata via an asynchronous extract API; requires a free account, data cannot be redistributed.
