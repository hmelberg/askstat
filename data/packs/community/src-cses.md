...
A harmonised cross-national post-election respondent survey (~50
countries, Modules 1-5, 1996-2021+), open after free registration.



Module-to-module harmonisation is imperfect — check each module's
codebook for variable availability by country-year before assuming
comparability.
