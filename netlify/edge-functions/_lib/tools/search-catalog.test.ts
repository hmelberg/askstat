...
const REG = parseRegistry([
  ...
  { id: "datanorge", navn: "data.norge.no", utgiver: "Digdir", beskrivelse: "test", tillit: "offisiell", tilgang: "ckan",
    base_url: "https://data.norge.no/",
    sok_endepunkt: "https://search.api.fellesdatakatalog.digdir.no/search", cors: true },
  { id: "apd", navn: "Awesome Public Datasets", utgiver: "apd-core", beskrivelse: "test", tillit: "funnet",
