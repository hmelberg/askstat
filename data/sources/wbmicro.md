---
id: wbmicro
navn: World Bank Microdata Library (NADA-API)
...
# World Bank Microdata Library (NADA-API)

## Kort

søk (7000+ surveys) + FULL variabelordbok (spørsmålstekst, verdietiketter) er åpne og nøkkelfrie; selve datafilene er login-gated — metadata må ALDRI presenteres som dataverdier; samme API hos IHSN/FAO — se guiden
...
World Bank Microdata Library — a catalogue of about 7,100 household, health, and labour-market survey studies worldwide with full variable dictionaries; the data files themselves are login-gated.
