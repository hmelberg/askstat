...
True microdata — household survey on migration drivers and aspirations.
An open-access variant is available on Zenodo.



The open Zenodo variant masks/aggregates some variables (e.g. precise
geolocation) relative to the full dataset.
