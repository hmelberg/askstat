...
survey-mikrodata (holdninger/velferd/helse, ~30 europeiske land inkl. Norge, 2002–): parquet/csv per fil-DOI; suksess = 307-redirect til signert fil-URL (~1 t gyldig, proxyen følger); ess11-csv = 32 MB verifisert — se guiden
