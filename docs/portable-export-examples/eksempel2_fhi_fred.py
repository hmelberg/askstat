...
# connect fred
# read /api/hent?url=...FHI-url...&body=...json-stat2-body... as hjertekar  (se full eksport i appen)
...
# read fred/series/observations?series_id=UNRATE&file_type=json as usa_ledighet, kind(json)
