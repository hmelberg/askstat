---
id: cdc
navn: data.cdc.gov (Socrata SODA)
utgiver: CDC
tillit: offisiell
tilgang: rest
base_url: https://data.cdc.gov/resource/
cors: true
sporrings_url_mal: https://data.cdc.gov/resource/{id}.json?$limit=1000
tags: [makro, usa]
order: 28
---
...
1078 datasett (BRFSS/PLACES-prevalens, dødelighet, vaksinasjon, kroniske sykdommer) — aggregert statistikk, IKKE mikrodata; SoQL ($where/$select/$group) server-side; nøkkelfri + CORS-åpen — se guiden
...
data.cdc.gov (Socrata) — CDC's open-data portal with 1,078 datasets of aggregated US health statistics (disease prevalence, mortality, vaccination); not microdata.
